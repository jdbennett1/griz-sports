...
export declare class STBase<PropType extends ISTOptions = ISTOptions, StateType extends ISTState = ISTState> extends BaseComponent<PropType, StateType> {
    ...
    _onResourceDragStart: (args: ICalendarEventDragArgs) => void;
    _onResourceDragMove: (args: ICalendarEventDragArgs) => void;
    _onResourceDragEnd: (args: ICalendarEventDragArgs) => void;
    ...
    protected _flattenResources(resources: MbscResource[] | null | undefined, flat: MbscResource[], depth: number, copy?: MbscResource[], fixed?: boolean, parentId?: number | string): MbscResource[];
     ...
     */
    protected _setViewDates(scrollPos?: number): void;
